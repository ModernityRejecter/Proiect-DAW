        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductProposals_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductProposals_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Products_ProductProposals_ProposalId",
                        column: x => x.ProposalId,
                        principalTable: "ProductProposals",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProposalFeedbacks_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProposalFeedbacks_ProductProposals_ProposalId",
                        column: x => x.ProposalId,
                        principalTable: "ProductProposals",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductProposals_CategoryId",
                table: "ProductProposals",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductProposals_UserId",
                table: "ProductProposals",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProposalFeedbacks_ProposalId",
                table: "ProposalFeedbacks",
                column: "ProposalId");

            migrationBuilder.CreateIndex(
                name: "IX_ProposalFeedbacks_UserId",
                table: "ProposalFeedbacks",
                column: "UserId");
